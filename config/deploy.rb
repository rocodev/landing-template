...
role :web, "landing.com"                          # Your HTTP server, Apache/etc
role :app, "landing.com"                         # This may be the same as your `Web` server
role :db,  "landing.com"   , :primary => true # This is where Rails migrations will run
